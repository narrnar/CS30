...
//  Project#1
//
//  Created by Daren Sivam on 9/13/22.
//
...
public:
    ...
    WeddingGuest(const WeddingGuest& wgList); //copy constructor
    
    ~WeddingGuest(); //destructor
    
    const WeddingGuest& operator=(const WeddingGuest& wgList); //assigment operator
    //swap function to swap heads of lists
    void swap(WeddingGuest &wgList);
